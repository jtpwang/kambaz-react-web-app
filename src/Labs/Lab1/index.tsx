...
export default function Lab1LandingPage() {
    return (
        <div id="wd-lab1-landing">
            ...
            <a
                href="https://github.com/jtpwang/kambaz-react-web-app.git"
                target="_blank"
            ...
            <div id="wd-lab1">
                ...
                <div id="wd-images">
                    ...
                    <img id="wd-python" src="images/python.jpg" height="200px" />
                </div>
                <div id="wd-forms">
                    <h4>Form Elements</h4>
                    <form id="wd-text-fields">
                        ...
                        <input placeholder="jdoe" id="wd-text-fields-username" type="text" />
                        <br />
                        <label htmlFor="wd-text-fields-password">Password:</label>
                        <input id="wd-text-fields-password" type="password" value="12345" />
                        <br />
